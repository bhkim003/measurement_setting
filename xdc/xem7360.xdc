...
# MC1-3 
set_property PACKAGE_PIN A17 [get_ports {input_streaming_data_from_fpga_to_asic[1]}]
set_property IOSTANDARD LVCMOS18 [get_ports {input_streaming_data_from_fpga_to_asic[1]}]
# MC1-4 
set_property PACKAGE_PIN B19 [get_ports {input_streaming_data_from_fpga_to_asic[2]}]
set_property IOSTANDARD LVCMOS18 [get_ports {input_streaming_data_from_fpga_to_asic[2]}]
# MC1-7 
set_property PACKAGE_PIN G17 [get_ports {input_streaming_data_from_fpga_to_asic[3]}]
...
# MC1-98 
set_property PACKAGE_PIN G11 [get_ports {start_ready_from_asic_to_fpga}]
...
# MC1-100 
set_property PACKAGE_PIN F10 [get_ports {input_streaming_valid_from_fpga_to_asic}]
...
# MC2-25 
set_property PACKAGE_PIN Y23 [get_ports {clk_clock_generator}]
set_property IOSTANDARD LVCMOS18 [get_ports {clk_clock_generator}]



# MC2-27 
set_property PACKAGE_PIN AA24 [get_ports {clk_port_spare_0}]
set_property IOSTANDARD LVCMOS18 [get_ports {clk_port_spare_0}]



# MC2-29 
set_property PACKAGE_PIN Y22 [get_ports {clk_port_spare_1}]
...
# input
set_input_delay -clock [get_clocks clk_out1_clk_wiz_1] -max 2.000 [get_ports {input_streaming_ready_from_asic_to_fpga start_ready_from_asic_to_fpga inferenced_label_from_asic_to_fpga}]
...
# output
set_output_delay -clock [get_clocks clk_out1_clk_wiz_1] -max 2.000 [get_ports {input_streaming_data_from_fpga_to_asic[*]}]
set_output_delay -clock [get_clocks clk_out1_clk_wiz_1] -min 0.300 [get_ports {input_streaming_data_from_fpga_to_asic[*]}]

set_output_delay -clock [get_clocks clk_out1_clk_wiz_1] -max 2.000 [get_ports {reset_n_from_fpga_to_asic input_streaming_valid_from_fpga_to_asic start_training_signal_from_fpga_to_asic start_inference_signal_from_fpga_to_asic}]
set_output_delay -clock [get_clocks clk_out1_clk_wiz_1] -min -1.010 [get_ports {reset_n_from_fpga_to_asic input_streaming_valid_from_fpga_to_asic start_training_signal_from_fpga_to_asic start_inference_signal_from_fpga_to_asic}]