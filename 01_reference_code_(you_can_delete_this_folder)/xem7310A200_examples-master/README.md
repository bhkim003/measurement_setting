# XEM7310A200 FPGA Examples

This repository contains a collection of example projects for the Opal Kelly XEM7310A200 FPGA development board. These examples demonstrate various features and capabilities of the board, from basic LED control to more complex operations like DRAM access, FIFO operations, and data transfer using different pipe interfaces.
...
1. Clone this repository:
   ```
   git clone https://github.com/ojy0216/xem7310A200_examples.git
   cd xem7310A200_examples
   ```
...
3. Connect your XEM7310A200 board to your computer.
